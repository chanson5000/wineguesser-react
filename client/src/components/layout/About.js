  ...
  render() {
    return (
        <div className="container text-center">
          ...
          <p>
            Wine guesser uses wine characteristic information and testing criteria used by those attempting to receive accreditation by the <RemoteLink url="https://www.mastersommeliers.org/" text="Court of Master Sommeliers" newWindow={true}/> . When blind tasting a wine, input evaluated characteristics into the form and see how close you are to picking out key indicators of the wine.
          </p>
          <p>
